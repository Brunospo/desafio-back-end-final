...
const { validateBodyFields, validateProductId, validateCategoryQuery, validateIfHasProductInOrder, verifyIfHasImg } = require('../middlewares/productMiddleware');
...
router.put('/:id', validateProductId, validateBodyFields, verifyIfHasImg, editProduct);
